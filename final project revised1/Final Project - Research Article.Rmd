...
When we generated two-way tables, we did not include null values. However, a lot of observations have at least one null value of the variables, we decided to keep all the observations.
...
ggplot(data=horse,aes(x=rectal_temp,fill=outcome)) + 
  geom_histogram(bins=10,color="blue") + labs(title = "Horses Rectal Temp Distribution Across Outcomes", fill = "Outcome", x = "Rectal Temperature",y="Count")
