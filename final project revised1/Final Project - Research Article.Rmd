...
ht1= ggplot(data=horse %>% filter(outcome=="died"),aes(y=rectal_temp)) + geom_histogram(bins=10,color="red") + coord_flip() + labs(title = "Died Horses by rectal temp") 

ht2= ggplot(data=horse %>% filter(outcome=="euthanized"),aes(y=rectal_temp)) + geom_histogram(bins=10,color="green") + coord_flip() + labs(title = "Euthan. Horses by rectal temp")
ht3= ggplot(data=horse %>% filter(outcome=="lived"),aes(y=rectal_temp)) + geom_histogram(bins=10,color="blue") + coord_flip() + labs(title = "Lived Horses by rectal temp")
...
The average temperatures are similar between the three outcomes; died, euthanized, and lived, but died horses’ temperatures are slightly higher and euthanized horses’ temperatures are lower than the other two and higher variation for died and euthanized horses. The distribution for lived horses had more stable rectal temperatures than the other two groups.
