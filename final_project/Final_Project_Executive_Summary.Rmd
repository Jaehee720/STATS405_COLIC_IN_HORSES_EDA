...
```{r echo = F, warning = F,  fig.show="hold", message = F, fig.cap = "Horse Outcome vs Surgery Performed"}
...
horse %>%
  ...
  theme(aspect.ratio = 0.5, axis.title.x = element_text(size = 9), axis.title.y = element_text(size = 9), plot.title = element_text(hjust = 0.5, size = 11))
```
